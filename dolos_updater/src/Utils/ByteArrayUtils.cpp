...
public:
    ...
    std::vector<uint8_t> combineArrays(const std::vector<uint8_t>& array1, const std::vector<uint8_t>& array2) {
...
std::vector<uint8_t> combineArrays(const std::vector<uint8_t>& array1, const std::vector<uint8_t>& array2, const std::vector<uint8_t>& array3) {
...
std::vector<uint8_t> combineArrays(const std::vector<uint8_t>& array1, const std::vector<uint8_t>& array2, const std::vector<uint8_t>& array3, const std::vector<uint8_t>& array4) {
